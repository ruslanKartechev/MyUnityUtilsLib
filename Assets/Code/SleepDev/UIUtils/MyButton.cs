...
namespace SleepDev
{
    public class MyButton : MonoBehaviour, IButtonInput
    {
        ...
        public Color color
        {
            get => _btn.targetGraphic.color;
            set => _btn.targetGraphic.color = value;
        }
        ...
        /// <summary>
        /// Will only change the visual color of the button. Does not change 'interactable' state
        /// </summary>
        /// <param name="interactable"></param>
        public void SetColorInteractable(bool interactable)
        {
            _btn.targetGraphic.color = interactable ? _btn.colors.normalColor : _btn.colors.disabledColor;
        }
